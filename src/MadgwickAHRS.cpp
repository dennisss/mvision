...
#define betaA sqrt(3.0f / 4.0f) * GyroMeasError   // compute beta

volatile float beta = betaA; //betaDef;								// 2 * proportional gain (Kp)
volatile float q0 = 1.0f, q1 = 0.0f, q2 = 0.0f, q3 = 0.0f;	// quaternion of sensor frame relative to auxiliary frame


void MadgwickAHRSgetquaternion(float *buff){
	buff[0] = q0;
	buff[1] = q1;
	buff[2] = q2;
	buff[3] = q3;
