...
/**
 * Based on googlesamples/android-Camera2Video
 */
...
/*
        ...
        ToggleButton recordBtn = (ToggleButton) findViewById(R.id.toggleButton);
...
*/
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        mTextureView = (AutoFitTextureView) view.findViewById(R.id.surfaceView);
        mButtonVideo = (Button) view.findViewById(R.id.toggleButton);
    ...
    private static Size chooseVideoSize(Size[] choices) {
        ...
        for (Size size : choices) {
            if(size.getHeight() == 1440 && size.getWidth() == 1920)
                return size;
    ...
    private File getVideoFile(Context context) {
        return new File("/sdcard/MVision", "temp.mp4");
    ...
    private void stopRecordingVideo() {
        ...
        mButtonVideo.setText( "Record" /*R.string.record*/ );
        // Stop recording
        mMediaRecorder.stop();
        mMediaRecorder.reset();
        Activity activity = getActivity();
